<#assign content>
  <div class="centralize">
    <div id="queryWindow" class="shadow">
      <div id="tabsWrapper">
        <a id="neighborsTab" class="tab lightgreen active" href="/neighbors">neighbors.cs32</a>
        <a id="radiusTab" class="tab lightgreen" href="/radius">radius.cs32</a>
      </div>
      <div id="queryWindowInnerWrapper">
        ...
        <div id="queryWindowRight">
          <div id="content">
            <h1 class="green">
              /**
              <br/>&nbsp;* Stars 3: use this to search for the nearest-
              <br/>&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;neighbor stars to a given point or star.
              <br/>&nbsp;*/
            </h1>
            <br/>
            ...
            <p>
              ...
              <span class="yellow">search_for_neighbors</span>() {
            </p>
            <form method="GET" action="/neighbors">
              <label for="neighbors"> No. Of Neighbors </label>
              <input id="neighbors" class="textInput" type="number"
                     name="neighbors" required min="1" step="1"
